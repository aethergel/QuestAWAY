...
namespace QuestAWAY
{
    public static class Static
    {
        ...
        {
            //기존의 알파벳 순에서 사용하기 편하도록 임의로 순서변경
            { Category.All, "모두" },
            { Category.MSQ, "주요 퀘스트" },
            { Category.Quest, "퀘스트" },
            { Category.QuasiQuest, "보조 퀘스트" },
            { Category.LinkedQuest, "지역 이동 퀘스트" },
            { Category.FeatureQuest, "기능 퀘스트" },
            { Category.BeginnerQuest, "초보자 퀘스트" },
            { Category.AreaMarkers, "지역 이동" },
            { Category.DungeonRaid, "던전/토벌전/레이드" },
            { Category.FATE, "돌발" },
            { Category.NPC, "NPC" },
            { Category.TripleTriad, "트리플 트라이어드" },
            { Category.GATE, "돌발 게임" },
            { Category.Housing, "하우징" },
            { Category.FCHousing, "자유부대 하우징" },
            { Category.Island, "무인도" },
            { Category.Behest, "의뢰" },
            { Category.Levemete, "길드 의뢰" },
            { Category.Lore, "세계관" },
            { Category.AlliedSociety, "우호 부족" },
            { Category.Guild, "길드" },
            { Category.MiniMapOnly, "미니맵" },
            { Category.Miscellanous, "기타" },
            /* Category so good had to save it for later(saving its original sorting order)
            { Category.All, "모두" }, // This is a pseudo category and it shouldnt be assigned to an icon
            { Category.AlliedSociety, "우호 부족" },
            { Category.AreaMarkers, "지역 이동" },
            { Category.BeginnerQuest, "초보자 퀘스트" },
            { Category.Behest, "의뢰" },
